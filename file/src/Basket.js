...
const Basket = () => {
  ...
  return (
    <div className="mkfjjhlefvwff">
      <div className="flex-container">
        <img className="group-11" onClick={() => navigate("/Homepage")} src={group11} />
        <span className="ijxfgshprpjal">Корзина</span>
      </div>
      <span className="bgplktltxcpaw">Промокод</span>
      <div className="flex-container-1">
        <input className="rectangle-33" placeholder="Введите код" type="text" />
        <div className="rectangle-34">Активировать</div>
      </div>
      <span className="zibyiptvtzmwk">Вы заказали</span>
      <hr className="line-8" />
      <div className="flex-container-2">
        <img className="rectangle-35" src={rectangle35} />
        <span className="xadngicvuwyxh">Название блюда</span>
        <img className="group-13" src={group13} />
      </div>
      <div className="flex-container-3">
        <span className="num-130">130 руб</span>
        <hr className="line-6" />
        <span className="qbdwswohxorvd">1</span>
      ...
      <span className="qzirexzguqngz">Добавить к заказу</span>
      <hr className="line-9" />
      <div className="flex-container-8">
        <img className="rectangle-35-2" src={rectangle35} />
        <span className="oxyoxnsxtdexu">Название блюда</span>
      ...
      <div className="flex-container-9">
        ...
        <span className="lczwihomwbtia">0</span>
        <img className="group-142" src={group14} />
      </div>
      <hr className="line-91" />
      <span className="qlfcloizugbtk">Общее время готовки: *макс. время*</span>
      <div className="rectangle-36">
        <span className="num-260">260 руб</span>
        <span className="kxllpsmqyhipd" onClick={() => navigate("/Samv")}>Оформить заказ</span>
      </div>
    </div>
  );
};
